...
wald_test_bnb <- function(
  ...
  sigma <- sqrt(
    mle_ratio *
      (1 + mle_ratio) *
      (mle_mean1 + mle_mean2 + mle_dispersion) /
      (n1 *
        ((mle_mean1 + mle_mean2) *
          (mle_mean1 + mle_dispersion) -
          mle_dispersion * mle_ratio))
  )
  ...
  method <- paste0(
    ...
    " Wald test for bivariate negative binomial ratio of means"
  )
